...
const Valentine = () => {
    ...
    return (
        <section className={' w-full mt-20 items-center gap-10 ' +
            ' font-love text-6xl flex flex-col justify-center text-pink-600 '}>
            <Confetti className={`${!hasClicked && 'hidden'}`}
                      width={width}
                      height={height}
            />
            <div className={`${!hasClicked && 'hidden'}`}>
                <motion.div
                    className={`${!hasClicked && 'hidden'}  z-50 font-bold text-6xl`}
                    variants={{
                        hidden: {opacity: 0, y: -100, rotate: -180},
                        visible: {opacity: 1, y: 0, rotate: 360000}
                    }}
                    initial="hidden"
                    animate={hasClicked ? "visible" : "hidden"}
            ...
            <div className={`flex flex-row gap-10  ${hasClicked && 'hidden'}`}>
                <motion.h1
                    initial={{opacity: 0, y: 200}} animate={{opacity: 1, y: 0}}
                    transition={{duration: 1, ease: "easeInOut"}}> Will
                </motion.h1>
                <motion.h1
                    initial={{opacity: 0, y: 200}} animate={{opacity: 1, y: 0}}
                    transition={{delay: 0.5, duration: 1, ease: "easeInOut"}}> You
                </motion.h1>
                <motion.h1
                    initial={{opacity: 0, y: 200}} animate={{opacity: 1, y: 0}}
                    transition={{delay: 1, duration: 1, ease: "easeInOut"}}> Be
                </motion.h1>
            ...
            <div className={`flex flex-row gap-10 ${hasClicked && 'hidden'}`}>
                <motion.h1
                    initial={{opacity: 0, y: 200, rotate: -180}} animate={{opacity: 1, y: 0, rotate: 0}}
                    transition={{delay: 2, duration: 4, ease: "easeInOut"}}> Valentine
                </motion.h1>
            </div>
            <div className={` flex flex-row gap-10 ${!hasClicked && 'hidden'}`}>
                <motion.div
                    className={`${!hasClicked && 'hidden'}  w-64 h-64 left-64`}
                    variants={{
                        hidden: {opacity: 0, y: 0, rotate: -180},
                        visible: {opacity: 1, y: 0, rotate: 360000}
                    }}
                    initial="hidden"
                    animate={hasClicked ? "visible" : "hidden"}
                ...
                >
                    <img src="M2.jpeg" alt="my2"/>
                </motion.div>
                <motion.div
                    className={`${!hasClicked && 'hidden'} w-64 h-64 rounded-lg`}
                    variants={{
                        hidden: {opacity: 0, y: -100, rotate: -180},
                        visible: {opacity: 1, y: 0, rotate: 360000}
                    }}
                    ...
                    transition={{duration: 1, ease: "easeInOut"}}
                >
                    <img src="My1.jpeg" alt="my2"/>
                </motion.div>
            </div>

            <div className={'relative'}>
                <motion.div
                    className={`${!hasClicked && 'hidden'} w-32 h-32 absolute right-32 top-10`}
                    variants={{
                        hidden: {opacity: 0, y: -100, rotate: -180},
                        visible: {opacity: 1, y: 0, rotate: 360000}
                    }}
                ...
                <motion.div
                    className={`${!hasClicked && 'hidden'} absolute w-32 h-32 left-32 top-10`}
                    variants={{
                        hidden: {opacity: 0, y: 0, rotate: -180},
                        visible: {opacity: 1, y: 0, rotate: 360000}
                    }}
                ...
                <motion.div initial={{opacity: 0, y: 200}} animate={{opacity: 1, y: 0}} transition={{delay: 8}}>
                    <motion.div
                        whileTap={{scale: 3}}
                    ...
                    >
                        ...
                        >
                            ...
                            {hasClicked && (
                                // https://primer.style/octicons-v2/heart-fill-16
                                <path
                                    fill={'#D81B60'}
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                ...
                <div className={`absolute ${!hasClicked && 'hidden'}`}>
                    <video className={'w-64  border-black'} src={'Love.MOV'} autoPlay muted loop></video>
                </div>
            </div>
